...
class ObjectTransformer {
    ...
    public static function arrangement(Arrangement $arrangement) : array{
        ...
        return [
            ...
            'start_date' => $arrangement->getStart(),
            'stop' => $arrangement->getStop()->getTimestamp(),
            'stop_date' => $arrangement->getStop(),
            'paameldingsfrist_1' => $arrangement->getFrist1()->getTimestamp(),
            'paameldingsfrist_1_date' => $arrangement->getFrist1(),
            'paameldingsfrist_2' => $arrangement->getFrist2()->getTimestamp(),
            'paameldingsfrist_2_date' => $arrangement->getFrist2(),
    ...
    public static function innslag(Innslag $innslag, ?Arrangement $arrangement = null) : array {
        ...
        $obj = [
            ...
            'bilde' => $innslag->getRepresentasjonBilde(),
        ];
