...
class Titler {
	...
	private function _setTable( $table ) {
		...
		switch( $table ) {
			...
			case 'smartukm_titles_video':
				...
				break;
			default:
				throw new Exception('TITLER: Tittel-type ('.$table .') ikke støttet');
		}
	...
	**/
	...
	private function _setInnslagType( $type ) {
		...
		throw new Exception('TITLER_COLLECTION: Innslag-type må være angitt som objekt, ikke '. get_class($type));
	}
