...
CREATE TABLE `ukm_nominasjon` (
  ...
  `niva` enum('land','fylke') COLLATE utf8mb4_danish_ci NOT NULL DEFAULT 'land',
  `fylke_id` int(2) NOT NULL,
  `kommune_id` int(5) NOT NULL,
  ...
  KEY `type` (`type`),
  KEY `niva` (`niva`),
  KEY `kommune_id` (`kommune_id`),
  KEY `fylke_id` (`fylke_id`),
  KEY `season` (`season`)
) ENGINE=InnoDB AUTO_INCREMENT=293 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_danish_ci;
